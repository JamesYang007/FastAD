...
TEST_F(admath_fixture, Add_vec) 
{
    check_binary_vec<Add>([](auto x, auto y) { return x + y; });
}

TEST_F(admath_fixture, Sub_scl) 
{
...
TEST_F(admath_fixture, Sub_vec) 
{
    check_binary_vec<Sub>([](auto x, auto y) { return x - y; });
}

TEST_F(admath_fixture, Mul_scl) 
{
...
TEST_F(admath_fixture, Mul_vec) 
{
    check_binary_vec<Mul>([](auto x, auto y) { return x * y; });
}

TEST_F(admath_fixture, Div_scl)
{
